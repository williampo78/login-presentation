<template>
  <div class="md:flex md:justify-center">
    <div class="md:flex md:max-w-[1200px]">
      ...
      />
      <form
        class="py-[60px] px-[15px] bg-white md:border rounded md:border-silver md:w-[620px]"
        action=""
      >
        ...
        <div class="flex my-4 justify-center">
          <a
            class="text-green pr-6 mr-6 border-black border-r font-bold"
            href=""
            >忘記密碼</a
          >
          <p>我還不是會員，</p>
          <a class="text-green flex font-bold" href=""
